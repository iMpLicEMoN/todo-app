...
class AddTodo extends Component {
    ...
    handleSubmit = (e)=>{
        ...
        console.table(((!this.state.todo.id) || (this.state.todo.id==="")))

        if ((!this.state.todo.id) || (this.state.todo.id==="")) {
            this.setState({...this.state, todo: {...this.state.todo, id: genID()}})
        } else { 
                this.setState({...this.state, todo: {...this.state.todo, id: this.state.todo.id}}) 
            }
